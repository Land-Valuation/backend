...
const HomePage = () => {
  ...
  const userToken = UserService.getTokenParsed();
  const userRole = userToken?.realm_access?.roles || [];
  const hasAdminRole = userRole.some(
      (role) => role.includes(ADMIN_ROLES.ROLE_SUPER_ADMIN) ||
          role.includes(ADMIN_ROLES.ROLE_ADMIN));
  ...
  return (<Box
      ...
      >
        ...
        >
          ...
          {hasAdminRole && (<Box className="menu-chooser">
                <div
                    style={{
                ...
                >
                  ...
                  <Typography
                      sx={{
                        fontFamily: 'Poppins', fontWeight: 500, fontSize: 18,
                      }}
                  >
                    {t('Admin')}
                  </Typography>

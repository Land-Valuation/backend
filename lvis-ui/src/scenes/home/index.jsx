...
function LoginIcon(props) {
  return (<SvgIcon {...props} viewBox="0 0 16 17">
...
function SignupIcon(props) {
  return (<SvgIcon {...props} viewBox="0 0 14 15">
    <path
    ...
    <Box sx={{flex: 1}}>
      {notifications.map((item, index) => (<Box
          ...
          sx={{
            ...
            alignItems: 'center',
            padding: '5px 0', //borderBottom: index !== notifications.length - 1 ? '1px solid #e0e0e0' : 'none',
            gap: '270px',
          }}
      >
        {/* Notification title */}
